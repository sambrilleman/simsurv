...
If you find any bugs, please [file an issue on GitHub](https://github.com/sambrilleman/simsurv/issues).

## References

1.  Brilleman SL, Wolfe R, Moreno-Betancur M, and Crowther MJ. Simulating survival data using the simsurv R package. *Journal of Statistical Software* 2021; **96**(9), 1--27. doi:10.18637/jss.v097.i03.  https://www.jstatsoft.org/article/view/v097i03
...
5. Crowther MJ, and Lambert PC. Simulating complex survival data. *The Stata Journal* 2012; **12**(4), 674--687. https://www.stata-journal.com/sjpdf.html?articlenum=st0275

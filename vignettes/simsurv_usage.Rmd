...
The flexible parametric survival model will be based on the method of Royston and Parmar (2002); i.e. restricted cubic splines are used to approximate the log cumulative baseline hazard. This model can be estimated using the `flexsurvspline` function from the **flexsurv** R package (Jackson (2016)). 
...
### Example 3: Simulating under a Gompertz survival model with time-dependent effects
